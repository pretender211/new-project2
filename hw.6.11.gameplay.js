...
if (pathChoose == "right") {
  ...
  var pathLeft = prompt(
    "Wow you found a diamond sword, do you want to get it?"
  );
...
if (isDead == true) {
  var attackMonsters = prompt(
    "Monsters have attacked you, use the sword and defeat them!"
  );
  if (attackMonsters == "attack") {
    var defeatMonsters = prompt(
      "You received iron armor, do you want to get it?"
    );
    score++;
  ...
  var townVillagers = prompt(
    "There is a village ahead, do you want to go there?"
  );
  if (townVillagers == "yes") {
    var vilShop = prompt(
      "You went to the village and saw an equipment store, do you want to buy something?"
    );
  } else if (vilShop == "yes") {
    var storeSomething = prompt(
      "You can buy" +
        "\n" +
        "Crossbow" +
        "\n" +
  ...
  if (night == "yes") {
    alert(
      "You spent the night in a Village and received the (First Night) achievement!"
    );
    score++;
  } else if (night == "no") {
    alert(
      "You were attcked by monsters at night when you were sleepy and you died, try again!"
    );
  }
  ...
  if (pathFood == 1) {
    alert(
      "You have successfully eaten and received the (Hunger Relief) achievement"
    );
    score++;
  } else if (pathFood == 2) {
    alert(
      "You couldn't eat enough in the forest and died of hunger, try again!"
    );
  }

  var saveVillage = prompt(
    "Monsters have attacked the village! Quickly protect them from them!" +
      "\n" +
      "1)Save the village" +
      "\n" +
  ...
  if (saveVillage == 1) {
    alert(
      "You have successfully saved the village and received a reward in the form of Diamond Armor!"
    );
    score++;
  ...
  var pathCemetry = prompt(
    "You continued on your way and saw a cemetry in the distance!" +
      "\n" +
      "1)Go to the cemetry" +
      "\n" +
  ...
  if (pathCemetry == 1) {
    alert(
      "You went to the cemetry and suddenly the walking dead crawled out of their graves!" +
        "\n" +
        "Destroy them!"
    );
  ...
  var destroyZombie = prompt(
    "You have successfully destroyed the waalking dead and received a treasure map!" +
      "\n" +
  ...
  if (destroyZombie == 1) {
    var killDragon = prompt(
      "You followed the map and came across a treasure cave, but there is a Fire Breathing Dragon there" +
        "\n" +
  ...
  var kingMonsters = prompt(
    "In treasure you see that next to the gold is the location of the King of the monsters" +
      "\n" +
  ...
  if (kingMonsters == 1) {
    var cerberus = prompt(
      "You went to the lair of the King of the Monsters and came across Cerberus" +
        "\n" +
        "1)Kill Cerberus"
    );
  } else if (cerberus == 1) {
  ...
  var lordDead = prompt(
    "You went further and came across the Lord of the Dead" +
      "\n" +
      "1)Kill Lord of the Dead"
  );
  if (lordDead == 1) {
    alert(
      "You killed the Lord of the Dead and received the fast regeneration effect"
    );
    score++;
  ...
  var endGame = prompt(
    "Contiuning your journey you came across the King of the Monsters" +
      "\n" +
  ...
  if (endGame == 1) {
    alert(
      "You defeated the King oof the Monsters and freed the lands from hands of monsters"
    );
    score++;
    score++;
